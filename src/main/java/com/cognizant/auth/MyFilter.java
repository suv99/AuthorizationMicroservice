...
/**
 * 
 * We can perform authentication in filter. Here, we are going to check to
 * credentials given by the user in filter class, if credentials are correct,
 * request is forwarded to the respective page otherwise it will display error
 * message.
 *
 */
